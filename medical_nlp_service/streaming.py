...
# from constants import MEDICATION_SYNONYMS, MEDICAL_KEYWORDS
# from entity_extractor import filter_negated_entities, deduplicate_entities
# from soap_generator import generate_soap_note_rule_based
# from utils import align_transcription_with_speakers, get_audio_duration
# from shared_models import MedicalEntity, SpeakerSegment
# from shared_models import MedicalEntity, SpeakerSegment, RealtimeResult
# from shared_utils import AudioChunkGenerator
# from main import perform_diarization
...
#         filtered_entities = filter_negated_entities(transcript, normalized_entities)
        
#         # Deduplicate entities
#         final_entities = deduplicate_entities(filtered_entities)
...
#             return []
#         return perform_diarization(audio_path)
...
#         return align_transcription_with_speakers(transcript, speaker_segments, audio_duration)
